...
import com.java.configuration.MessageQueueClient;
import com.java.db.MongoDbConfig;
...
public class hellodropwizardApplication extends Application<MongoDbConfig> {

  GuiceBundle<MongoDbConfig> guiceBundle;
  ...
  public void initialize(final Bootstrap<MongoDbConfig> bootstrap) {
  ...
  @Override
  public void run(MongoDbConfig configuration, Environment environment) {
